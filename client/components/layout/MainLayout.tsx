    ...
    <div className="min-h-screen bg-[hsl(var(--bg-alt))]">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="relative">
              <Input
                placeholder="Search Vendors / Components"
      ...
      <footer className="border-t mt-8">
        <div className="container mx-auto px-4 py-6 text-xs text-muted-foreground">
          © {new Date().getFullYear()} Supply Chain Analytics Demo · Built with
          React + Tailwind · Risk colors: Low #12B76A, Moderate #F79009, High
          #F04438, Critical #B42318
        </div>
      </footer>
    </div>
  );
